...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="content container mt-5">
        <div class="error-container">
            ...
            Infelizmente o seu cpf e a sua matricula não foram encontrados no registro eleitoral. 
            </div>
            <a href="login.php" class="btn btn-primary btn-back">Voltar à Página Principal</a>
        </div>
    </div>
